 ...
 */
package com.company.ecommerce.portal.auth;
        ...
        if (authentication instanceof UsernamePasswordAuthenticationToken) {
            ...
            try {
                ...
                connection.login((String) token.getPrincipal(),
                        passwordEncryption.getPlainHash((String) token.getCredentials()), request.getLocale(), request.getRemoteAddr(), request.getHeader("User-Agent"));
