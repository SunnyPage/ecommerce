...
public class EcommerceTestContainer extends TestContainer {

    public EcommerceTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/company/ecommerce/app.properties",
    ...
    public static class Common extends EcommerceTestContainer {

        public static final EcommerceTestContainer.Common INSTANCE = new EcommerceTestContainer.Common();
